...
**Date:** 2026-03-06
**Entry Type:** Engineering Decision
**Task worked on:** Board spaces in the main() method. 
**Issue or decision:** I decided to hardcode each space in the main method. 
**Error message / symptom (if applicable):** N/A 
**What I tried:** I tried to use the example and define a vector called spaces, then add monopoly spaces in there. 
**Fix / resolution (or final decision):** After testing the vector hardcoding way, I decided to hardcode each space in the main method, which makes it easier to see and be for sure every space is written right. It also helps test and use the addMany() method as well. 
**Commit(s):** I wrote and completed the main method. I hardcoded all the monopoly board spaces in the main method by using the example vector and push_back lines given. This also lets me use and test the addMany method. Also it's just easier to hardcode instead of reading a file in my opinion, I just searched up a monopoly board and wrote the names and prices from there. 
